        ...
        e.extend(d, {
            version: {
                ...
                toString: function () {
                    ...
                    return (
                        e.isEmpty(e.version.metadata) ||
                            (a += '+' + e.version.metadata),
                        a
                    );
                },
            },
            ...
            runValidations: function (a, b, c) {
                ...
                for (d in b) {
                    (g = e.getDeepObjectValue(a, d)),
                        (h = e.result(b[d], g, a, d, c, b));
                    for (f in h) {
                        if (((i = e.validators[f]), !i))
                            throw (
                                ((k = e.format('Unknown validator %{name}', {
                                    name: f,
                                })),
                                new Error(k))
                            );
            ...
            contains: function (a, b) {
                return (
                    !!e.isDefined(a) &&
                    (e.isArray(a) ? a.indexOf(b) !== -1 : b in a)
                );
            },
            unique: function (a) {
                return e.isArray(a)
            ...
            collectFormValues: function (a, b) {
                ...
                for (
                    ...
                    if (
                        ((f = g.item(c)),
                        !e.isDefined(f.getAttribute('data-ignored')))
                    ) {
                ...
                for (
                    g = a.querySelectorAll('select[name]'), c = 0;
                    c < g.length;
                    ++c
                )
                    if (
                        ...
                        if (f.multiple) {
                            ...
                            for (d in f.options)
                                (h = f.options[d]),
                                    h &&
                                        h.selected &&
                                        i.push(e.sanitizeFormValue(h.value, b));
                        } else {
                            var l =
            ...
            cleanAttributes: function (a, b) {
                ...
                return e.isObject(b) && e.isObject(a)
                    ? ((b = d(b)), f(a, b))
                    : {};
            },
        ...
        (d.validators = {
            ...
            format: function (a, b) {
                ...
                if (e.isDefined(a))
                    return e.isString(a)
                        ? (e.isString(f) &&
                              (f = new RegExp(b.pattern, b.flags)),
                          (c = f.exec(a)),
            ...
            exclusion: function (a, b) {
                if (
                    ...
                    var c =
                        b.message || this.message || '^%{value} is restricted';
                    return (
            ...
            email: e.extend(
                function (a, b) {
                    ...
                    if (e.isDefined(a))
                        return e.isString(a) && this.PATTERN.exec(a)
                            ? void 0
                            : c;
                },
                {
            ...
            type: e.extend(
                function (a, b, c, d, f) {
                    if ((e.isString(b) && (b = { type: b }), e.isDefined(a))) {
                        ...
                        var i;
                        if (
                            ((i = e.isFunction(h) ? h : this.types[h]),
                            !e.isFunction(i))
                        )
                            throw new Error(
