        ...
        /******/ {
            ...
            /***/ 3: /***/ function (
                ...
                function isLeftEdgePointOf(point, ancestor) {
                    return (
                        isLeftEdgePoint(point) &&
                        dom_isLeftEdgeOf(point.node, ancestor)
                    );
                }
                /**
                ...
                var Context_Context = /*#__PURE__*/ (function () {
                    ...
                    _createClass(Context, [
                        ...
                        },
                        {
                            ...
                            value: function createInvokeHandler(
                                namespace,
                                value,
                            ) {
                                var _this4 = this;
                        ...
                        },
                        {
                            ...
                            value: function invoke() {
                                ...
                                var moduleName =
                                    hasSeparator && lists.head(splits);
                                ...
                                if (!moduleName && this[methodName]) {
                                    ...
                                    return module[methodName].apply(
                                        module,
                                        args,
                                    );
                                }
                        ...
                        summernote: function summernote() {
                            ...
                            this.each(function (idx, note) {
                                ...
                                if (!$note.data('summernote')) {
                                    var context = new Context_Context(
                                        $note,
                                        options,
                                    );
                ...
                function range_createClass(
                    Constructor,
                    protoProps,
                    staticProps,
                ) {
                    if (protoProps)
                        range_defineProperties(
                ...
                function pointToTextRange(point) {
                    var textRangeInfo = function textRangeInfo(
                        container,
                        offset,
                    ) {
                    ...
                    range_createClass(WrappedRange, [
                        ...
                        },
                        {
                            ...
                            value: function splitText() {
                                ...
                                if (
                                    ...
                                    boundaryPoints.sc = this.sc.splitText(
                                        this.so,
                                    );
                                    boundaryPoints.so = 0;
                        ...
                        },
                        {
                            ...
                            value: function isCollapsed() {
                                return (
                                    this.sc === this.ec && this.so === this.eo
                                );
                            },
                            /**
                ...
                /* harmony default export */ var range = {
                    ...
                    createFromSelection: function createFromSelection() {
                        ...
                        if (env.isW3CRangeSupport) {
                            ...
                            var startPoint = textRangeToPoint(
                                textRangeStart,
                                true,
                            );
                            var endPoint = textRangeToPoint(
                                textRangeEnd,
                                false,
                ...
                function History_createClass(
                    Constructor,
                    protoProps,
                    staticProps,
                ) {
                    if (protoProps)
                        History_defineProperties(
                            Constructor.prototype,
                            protoProps,
                        );
                    if (staticProps)
                ...
                function Style_createClass(
                    Constructor,
                    protoProps,
                    staticProps,
                ) {
                    if (protoProps)
                        Style_defineProperties(
                            Constructor.prototype,
                            protoProps,
                        );
                    if (staticProps)
                ...
                function Bullet_createClass(
                    Constructor,
                    protoProps,
                    staticProps,
                ) {
                    if (protoProps)
                        Bullet_defineProperties(
                            Constructor.prototype,
                            protoProps,
                        );
                    if (staticProps)
                            ...
                            value: function releaseList(
                                ...
                                external_root_jQuery_commonjs2_jquery_commonjs_jquery_amd_jquery_default.a.each(
                                    ...
                                    function (idx, paras) {
                                        ...
                                        if (
                                            headList.parentNode.nodeName ===
                                            'LI'
                                        ) {
                                            paras.map(function (para) {
                                                var newList =
                                                    _this4.findNextSiblings(
                                                        para,
                                                    );
                ...
                function Typing_createClass(
                    Constructor,
                    protoProps,
                    staticProps,
                ) {
                    if (protoProps)
                        Typing_defineProperties(
                            Constructor.prototype,
                            protoProps,
                        );
                    if (staticProps)
                ...
                var TableResultAction = function TableResultAction(
                    ...
                    function setStartPoint() {
                        ...
                        if (
                            ...
                            startPoint.parentElement.tagName.toLowerCase() !==
                                'tr'
                        ) {
                        ...
                        },
                        {
                            ...
                            value: function recoverAttributes(el) {
                                ...
                                for (var i = 0; i < attrList.length; i++) {
                                    if (
                                        attrList[i].name.toLowerCase() === 'id'
                                    ) {
                                        continue;
                                    }
                ...
                function Editor_createClass(
                    Constructor,
                    protoProps,
                    staticProps,
                ) {
                    if (protoProps)
                        Editor_defineProperties(
                            Constructor.prototype,
                            protoProps,
                        );
                    if (staticProps)
                ...
                var Editor_Editor = /*#__PURE__*/ (function () {
                    function Editor(context) {
                        ...
                        this.insertUnorderedList = this.wrapCommand(
                            function () {
                                _this.bullet.insertUnorderedList(
                                    _this.editable,
                                );
                            },
                        );
                    ...
                    Editor_createClass(Editor, [
                        ...
                        },
                        {
                            ...
                            value: function handleKeyMap(event) {
                                ...
                                var keyName =
                                    core_key.nameFromCode[event.keyCode];
                                ...
                                if (
                                    ...
                                    if (
                                        this.context.invoke(eventName) !== false
                                    ) {
                        ...
                        },
                        {
                            ...
                            value: function preventDefaultEditableShortCuts(
                                event,
                            ) {
                        ...
                        },
                        {
                            ...
                            value: function getLinkInfo() {
                                var rng = this.getLastRange().expand(
                                    dom.isAnchor,
                ...
                function _createForOfIteratorHelper(o) {
                    if (
                        ...
                        if (
                            Array.isArray(o) ||
                            (o = _unsupportedIterableToArray(o))
                        ) {
                            var i = 0;
                            var F = function F() {};
                            return {
                        ...
                        },
                        {
                            ...
                            value: function initialize() {
                                ...
                                this.$codable.on('keyup', function (event) {
                                    if (
                                        event.keyCode === core_key.code.ESCAPE
                                    ) {
                                        _this.deactivate();
                                    }
                                });
                ...
                function Handle_createClass(
                    Constructor,
                    protoProps,
                    staticProps,
                ) {
                    if (protoProps)
                        Handle_defineProperties(
                            Constructor.prototype,
                            protoProps,
                        );
                    if (staticProps)
                ...
                var AutoLink_AutoLink = /*#__PURE__*/ (function () {
                    function AutoLink(context) {
                        ...
                        this.options = context.options;
                        this.events = {
                            'summernote.keyup': function summernoteKeyup(
                                we,
                                e,
                            ) {
                    ...
                    Buttons_createClass(Buttons, [
                        {
                            ...
                            value: function representShortcut(editorMethod) {
                                var shortcut =
                                    this.invertedKeyMap[editorMethod];
                        ...
                        },
                        {
                            ...
                            value: function addToolbarButtons() {
                                ...
                                var _loop = function _loop(styleIdx, styleLen) {
                                    var item =
                                        _this2.options.styleTags[styleIdx];
                        ...
                        },
                        {
                            ...
                            value: function updateCurrentStyle($container) {
                                ...
                                this.updateBtnStates($cont, {
                                    ...
                                    '.note-btn-italic':
                                        function noteBtnItalic() {
                                            return (
                                                styleInfo['font-italic'] ===
                                                'italic'
                                            );
                                        },
                                    '.note-btn-underline':
                ...
                function Toolbar_createClass(
                    Constructor,
                    protoProps,
                    staticProps,
                ) {
                    if (protoProps)
                        Toolbar_defineProperties(
                            Constructor.prototype,
                            protoProps,
                        );
                    if (staticProps)
                            ...
                            value: function update(forcelyOpen) {
                                ...
                                if (
                                    ...
                                    this.$popover.css({
                                        ...
                                        top:
                                            rect.top + AIRMODE_POPOVER_Y_OFFSET,
                                    });
                                    this.context.invoke(
                                        'buttons.updateCurrentStyle',
                                        this.$popover,
                ...
                var HintPopover_HintPopover = /*#__PURE__*/ (function () {
                    ...
                    HintPopover_createClass(HintPopover, [
                        ...
                        },
                        {
                            ...
                            value: function createItemTemplates(
                                hintIdx,
                                items,
                            ) {
            ...
            /***/ 51: /***/ function (
                            ...
                            this.options.trigger
                                ...
                                .forEach(function (eventName) {
                                    if (eventName === 'hover') {
                                        ...
                                        $node
                                            .on('focus', showCallback)
                                            .on('blur', hideCallback);
                                    }
                                });
                        }
                    }
                ...
                /* harmony default export */ var ui_TooltipUI =
                    TooltipUI_TooltipUI;
                ...
                /* harmony default export */ var ui_DropdownUI =
                    DropdownUI_DropdownUI;
                ...
                function ModalUI_createClass(
                    Constructor,
                    protoProps,
                    staticProps,
                ) {
                    if (protoProps)
                        ModalUI_defineProperties(
                            Constructor.prototype,
                            protoProps,
                        );
                    if (staticProps)
                        ModalUI_defineProperties(Constructor, staticProps);
                    return Constructor;
                }
                ...
                var dropdownCheckButton = function dropdownCheckButton(
                    opt,
                    callback,
                ) {
                    return buttonGroup(
                ...
                var paragraphDropdownButton = function paragraphDropdownButton(
                    opt,
                ) {
                    return buttonGroup([
                        ui_button({
                ...
                var ui_tableMoveHandler = function tableMoveHandler(
                    event,
                    col,
                    row,
                ) {
                ...
                var ui_colorDropdownButton = function colorDropdownButton(
                    opt,
                    type,
                ) {
                    return buttonGroup({
                ...
                var ui = function ui(editorOptions) {
                    return {
                        ...
                        toggleBtnActive: function toggleBtnActive(
                            $btn,
                            isActive,
                        ) {
                        ...
                        check: function check($dom, value) {
                            ...
                            $dom.find('[data-value="' + value + '"]').addClass(
                                'checked',
                            );
                        },
                        onDialogShown: function onDialogShown(
                            $dialog,
                            handler,
                        ) {
                            $dialog.one('note.modal.show', handler);
                        },
                        onDialogHidden: function onDialogHidden(
                            $dialog,
                            handler,
                        ) {
