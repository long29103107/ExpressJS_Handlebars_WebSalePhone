                    ...
                    $.extend($.summernote.lang, {
                        'pt-PT': {
                            ...
                            help: {
                                ...
                                formatH1:
                                    'Alterar formato do bloco para Título 1',
                                formatH2:
                                    'Alterar formato do bloco para Título 2',
                                formatH3:
                                    'Alterar formato do bloco para Título 3',
                                formatH4:
                                    'Alterar formato do bloco para Título 4',
                                formatH5:
                                    'Alterar formato do bloco para Título 5',
                                formatH6:
                                    'Alterar formato do bloco para Título 6',
