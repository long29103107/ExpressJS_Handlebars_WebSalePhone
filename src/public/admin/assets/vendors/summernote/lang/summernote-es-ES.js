                    ...
                    $.extend($.summernote.lang, {
                        'es-ES': {
                            ...
                            image: {
                                ...
                                dragImageHere:
                                    'Arrastre una imagen o texto aquí',
                            ...
                            color: {
                                ...
                                reset: 'Restablecer',
                                resetToDefault:
                                    'Restablecer a los valores predefinidos',
                            ...
                            help: {
                                ...
                                formatPara:
                                    'Cambiar el formato del bloque actual a párrafo (etiqueta P)',
                                formatH1:
                                    'Cambiar el formato del bloque actual a H1',
                                formatH2:
                                    'Cambiar el formato del bloque actual a H2',
                                formatH3:
                                    'Cambiar el formato del bloque actual a H3',
                                formatH4:
                                    'Cambiar el formato del bloque actual a H4',
                                formatH5:
                                    'Cambiar el formato del bloque actual a H5',
                                formatH6:
                                    'Cambiar el formato del bloque actual a H6',
