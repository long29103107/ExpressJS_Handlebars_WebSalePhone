                    ...
                    $.extend($.summernote.lang, {
                        'ar-AR': {
                            ...
                            help: {
                                ...
                                formatPara:
                                    'تغيير التنسيق للكتلة الحالية إلى فقرة',
                                formatH1:
                                    'تغيير التنسيق للكتلة الحالية إلى ترويسة 1',
                                formatH2:
                                    'تغيير التنسيق للكتلة الحالية إلى ترويسة 2',
                                formatH3:
                                    'تغيير التنسيق للكتلة الحالية إلى ترويسة 3',
                                formatH4:
                                    'تغيير التنسيق للكتلة الحالية إلى ترويسة 4',
                                formatH5:
                                    'تغيير التنسيق للكتلة الحالية إلى ترويسة 5',
                                formatH6:
                                    'تغيير التنسيق للكتلة الحالية إلى ترويسة 6',
