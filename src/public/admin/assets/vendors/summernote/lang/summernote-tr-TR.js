                    ...
                    $.extend($.summernote.lang, {
                        'tr-TR': {
                            ...
                            help: {
                                ...
                                strikethrough:
                                    'Üstü çizgili yazma stilini ayarlar',
                                ...
                                formatPara:
                                    'Aktif bloğun biçimini paragraf (p) olarak değiştirir',
                                formatH1:
                                    'Aktif bloğun biçimini başlık 1 (h1) olarak değiştirir',
                                formatH2:
                                    'Aktif bloğun biçimini başlık 2 (h2) olarak değiştirir',
                                formatH3:
                                    'Aktif bloğun biçimini başlık 3 (h3) olarak değiştirir',
                                formatH4:
                                    'Aktif bloğun biçimini başlık 4 (h4) olarak değiştirir',
                                formatH5:
                                    'Aktif bloğun biçimini başlık 5 (h5) olarak değiştirir',
                                formatH6:
                                    'Aktif bloğun biçimini başlık 6 (h6) olarak değiştirir',
                                insertHorizontalRule: 'Yatay çizgi ekler',
                                'linkDialog.show':
                                    'Bağlantı ayar kutusunu gösterir',
                            },
                            history: {
                                undo: 'Geri al',
                                redo: 'Yinele',
