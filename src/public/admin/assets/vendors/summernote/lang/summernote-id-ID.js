                        ...
                        'id-ID': {
                            ...
                            image: {
                                ...
                                maximumFileSizeError:
                                    'Ukuran maksimal berkas terlampaui.',
                                url: 'URL gambar',
                                remove: 'Hapus Gambar',
                                original: 'Original',
                            },
                            ...
                            help: {
                                ...
                                strikethrough:
                                    'Mengaktifkan gaya strikethrough',
                                ...
                                formatPara:
                                    'Ubah format gaya tulisan terpilih menjadi paragraf',
                                formatH1:
                                    'Ubah format gaya tulisan terpilih menjadi Heading 1',
                                formatH2:
                                    'Ubah format gaya tulisan terpilih menjadi Heading 2',
                                formatH3:
                                    'Ubah format gaya tulisan terpilih menjadi Heading 3',
                                formatH4:
                                    'Ubah format gaya tulisan terpilih menjadi Heading 4',
                                formatH5:
                                    'Ubah format gaya tulisan terpilih menjadi Heading 5',
                                formatH6:
