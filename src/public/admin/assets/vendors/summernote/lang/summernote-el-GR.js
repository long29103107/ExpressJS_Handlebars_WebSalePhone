                    ...
                    $.extend($.summernote.lang, {
                        'el-GR': {
                            ...
                            video: {
                                ...
                                url: 'URL',
                                providers:
                                    '(YouTube, Vimeo, Vine, Instagram, DailyMotion ή Youku)',
                            },
                            table: {
                                table: 'Πίνακας',
                            ...
                            help: {
                                ...
                                insertUnorderedList:
                                    'Ορισμός μη-ταξινομημένης λίστας',
                                insertOrderedList:
                                    'Ορισμός ταξινομημένης λίστας',
                                outdent: 'Προεξοχή παραγράφου',
                                indent: 'Εσοχή παραγράφου',
                                formatPara:
                                    'Αλλαγή της μορφής του τρέχοντος μπλοκ σε παράγραφο (P tag)',
                                formatH1:
                                    'Αλλαγή της μορφής του τρέχοντος μπλοκ σε H1',
                                formatH2:
                                    'Αλλαγή της μορφής του τρέχοντος μπλοκ σε H2',
                                formatH3:
                                    'Αλλαγή της μορφής του τρέχοντος μπλοκ σε H3',
                                formatH4:
                                    'Αλλαγή της μορφής του τρέχοντος μπλοκ σε H4',
                                formatH5:
                                    'Αλλαγή της μορφής του τρέχοντος μπλοκ σε H5',
                                formatH6:
                                    'Αλλαγή της μορφής του τρέχοντος μπλοκ σε H6',
                                insertHorizontalRule:
                                    'Εισαγωγή οριζόντιας γραμμής',
                                'linkDialog.show':
                                    'Εμφάνιση διαλόγου συνδέσμου',
                            },
                            history: {
                                undo: 'Αναίρεση',
                                redo: 'Επαναληψη',
