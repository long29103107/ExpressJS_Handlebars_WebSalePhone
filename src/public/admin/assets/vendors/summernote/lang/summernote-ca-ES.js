                    ...
                    $.extend($.summernote.lang, {
                        'ca-ES': {
                            ...
                            image: {
                                ...
                                shapeNone: 'Forma: Cap',
                                dragImageHere:
                                    'Arrossegueu una imatge o text aquí',
                                dropImage:
                                    'Deixa anar aquí una imatge o un text',
                                selectFromFiles: 'Seleccioneu des dels arxius',
                                maximumFileSize: "Mida màxima de l'arxiu",
                                maximumFileSizeError:
                                    "La mida màxima de l'arxiu s'ha superat.",
                            ...
                            video: {
                                ...
                                url: 'URL del vídeo?',
                                providers:
                                    '(YouTube, Vimeo, Vine, Instagram, DailyMotion o Youku)',
                            },
                            link: {
                                link: 'Enllaç',
                            ...
                            help: {
                                ...
                                formatPara:
                                    "Canviar l'estil del bloc com a un paràgraf (etiqueta P)",
                                formatH1:
                                    "Canviar l'estil del bloc com a un H1",
                                formatH2:
                                    "Canviar l'estil del bloc com a un H2",
                                formatH3:
                                    "Canviar l'estil del bloc com a un H3",
                                formatH4:
                                    "Canviar l'estil del bloc com a un H4",
                                formatH5:
                                    "Canviar l'estil del bloc com a un H5",
                                formatH6:
                                    "Canviar l'estil del bloc com a un H6",
                                insertHorizontalRule:
                                    'Inserir una línia horitzontal',
