...
!(function () {
    ...
    var n,
        ...
        T = function (t) {
            return (
                (n = t), (r = 0) <= r && r < n.length ? y.some(n[r]) : y.none()
            );
            var n, r;
        },
        N = Object.keys,
        ...
        _ = function (o) {
                ...
                t = function (t, n, r) {
                    if (o.format === undefined)
                        return o.cmd !== undefined
                            ...
                            : a(
                                  t +
                                      ' pattern is missing both `format` and `cmd` parameters',
                              );
                    var e = void 0;
                    if (h(o.format)) {
                        if (!R(o.format, g))
                            return a(
                                t +
                                    ' pattern has non-string items in the `format` array',
                            );
                        e = o.format;
                    } else {
                        if (!g(o.format))
                            return a(
                                t +
                                    ' pattern has non-string `format` parameter',
                            );
                        e = [o.format];
                    }
                    return B.value(n(e));
            ...
            if (!g(o.start))
                return a('Raw pattern is missing `start` parameter');
            if (o.end === undefined)
                return o.replacement !== undefined
                    ? g(o.replacement)
                        ? 0 === o.start.length
                            ? a(
                                  'Replacement pattern has empty `start` parameter',
                              )
                            : B.value({
                                  type: 'inline-command',
                                  start: '',
            ...
            if (!g(o.end))
                return a('Inline pattern has non-string `end` parameter');
            if (0 === o.start.length && 0 === o.end.length)
                return a(
                    'Inline pattern has empty `start` and `end` parameters',
                );
            var r = o.start,
                e = o.end;
            return (
                ...
                getPatterns: function () {
                    return (function () {
                        ...
                        for (var e = Array(t), o = 0, n = 0; n < r; n++)
                            for (
                                var a = arguments[n], i = 0, u = a.length;
                                i < u;
                                i++, o++
                            )
                                e[o] = a[i];
                        ...
                        O(e.get().inlinePatterns, U),
                        O(e.get().blockPatterns, U),
                    );
                },
            };
        },
        ...
        gt = function (e, a) {
            ...
            return rt(e, t)
                ...
                .bind(function (n) {
                    ...
                    x(t, function (t) {
                        return (
                            0 === r.indexOf(t.start) || 0 === e.indexOf(t.start)
                        );
                    })).map(function (t) {
        ...
        kt = function (t, n, r) {
            Z(t, t.get(n.prefix + '-end'), r),
                Z(t, t.get(n.prefix + '-start'), r);
        },
        Ot = function (e, o, a, t) {
            var i,
                u = o.start;
        ...
        wt = function (a, i, u) {
            ...
            return it(l, d - u.pattern.end.length, i).bind(function (t) {
                ...
                })(f, s, r.container, r.offset, i, n.isNone()).map(function (
                    t,
                ) {
                    var n,
                        r = st(
        ...
        Ct = function (d, m, g, p, h) {
            ...
            return at(g, p, v.getRoot()).bind(function (t) {
                ...
                for (
                    var r, e, o, a, i, u = n.toString(), f = 0;
                    f < m.length;
                    f++
                ) {
                    var c = m[f];
            ...
            e =
                ((n = (function (t) {
                    ...
                    if (!h(n))
                        return (
                            W(
                                'The setting textpattern_patterns should be an array',
                            ),
