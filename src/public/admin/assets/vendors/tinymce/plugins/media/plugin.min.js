...
!(function () {
    ...
    var e,
        ...
        I = function (r, e) {
            var n = S.extend({}, e);
            if (!n.source && (S.extend(n, P(O(r), n.embed)), !n.source))
                return '';
        ...
        J = function (e, t) {
            ...
            return p(
                p(
                    p(p(p({}, a('source')), a('altsource')), a('poster')),
                    a('embed'),
                ),
                ((r = i),
                (n = {}),
        ...
        ie = function (e, t, r) {
            ...
            c &&
                (r.attr('data-mce-html', escape(ne(e, c))),
                (r.firstChild = null));
        },
        ae = function (e) {
            for (; (e = e.parent); )
                    ...
                    (t = e[c]).parent &&
                        (t.parent.attr('data-mce-object') ||
                            ...
                            (r &&
                                ...
                                r.height &&
                                    t.attr('height', r.height.toString())),
                            'iframe' === t.name &&
        ...
        return (
            ...
            (d = e).on('preInit', function () {
                ...
                S.each(
                    ...
                    d.serializer.addAttributeFilter(
                        'data-mce-object',
                        function (e, t) {
                            for (
                                var r, n, i, a, o, c, u, s, l = e.length;
                                l--;
