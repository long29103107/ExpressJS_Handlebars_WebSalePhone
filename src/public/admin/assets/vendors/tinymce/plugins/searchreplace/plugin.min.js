...
!(function () {
    ...
    var e,
        ...
        W = function (t, n) {
            var e;
            ((e = t), g.from(e.dom.parentNode).map(I.fromDom)).each(function (
                e,
            ) {
    ...
    var q,
        ...
        H =
            ...
            (V = 'text'),
            {
                get: function (e) {
                    if (!q(e))
                        throw new Error(
                            'Can only get ' + V + ' value of a ' + V + ' node',
                        );
                    return _(e).getOr('');
                },
        ...
        z = function (e, t) {
            return (
                e.isBlock(t) || D(e.schema.getShortEndedElements(), t.nodeName)
            );
        },
        G = function (e, t) {
        ...
        K = function (e, t) {
            return (
                !e.isBlock(t) && D(e.schema.getWhiteSpaceElements(), t.nodeName)
            );
        },
        J = function () {
                ...
                a,
                {
                    ...
                    cef: function (e) {
                        var t,
                            ...
                            r,
                            o = S(
                                U(I.fromDom(e), '*[contenteditable=true]'),
                                function (e) {
                                    var t = e.dom;
                                    return Z(i, t, t);
                                },
        ...
        ve = function (e, t, n, r, o) {
            ...
            for (
                ...
                if (o || m === a.index) {
                    ...
                    u < i && s[f].setAttribute('data-mce-index', String(i - 1));
            }
            return (
        ...
        ye = function (e, t, n) {
            ...
            if (
                (t.set(h(h({}, i), { index: -1, count: 0, text: '' })), r && o)
            ) {
