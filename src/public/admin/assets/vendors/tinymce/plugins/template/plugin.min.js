    ...
    var n,
            ...
            c &&
                ...
                _.each(a.select('*', r), function (e) {
                    ...
                    v(
                        e,
                        n
                            .getParam('template_cdate_classes', 'cdate')
                            .replace(/\s+/g, '|'),
                    ) &&
                        (e.innerHTML = p(
                            n,
        ...
        I = function (M, t) {
            ...
            (function () {
                ...
                return (
                    M.notificationManager.open({ text: e, type: 'info' }),
                    O.none()
                );
            })().each(function (o) {
                var b = e(o),
