...
!(function () {
    ...
    var W,
        ...
        Q = function (e, t, n) {
            var r,
                ...
                i = o
                    ? ((a = t),
                      (r = e).getParam('paste_enable_default_filters', !0)
                          ? Z(r, a)
                          : a)
                    : t;
            return J(e, i, n, o);
                ...
                !(p = e.getParam('images_dataimg_filter')) || p(m)
                    ? ((l = void 0),
                      (o = (a = e.editorUpload.blobCache).getByData(v, h))
                          ? (l = o)
                          : ((s = (i =
                                e.getParam('images_reuse_filename') &&
                                P(b.name))
                                ? ((c = e),
                                  (f = b.name),
        ...
        xe = function (s, u, l) {
            ...
            function m(e, t, n, r, a) {
                ...
                (o.length && (!i || s)) || (r = !0),
                    (r || s) &&
                        (o = de(t, 'text/plain') && i ? t['text/plain'] : q(o)),
            ...
            s.on('paste', function (e) {
                ...
                var n,
                    ...
                    a =
                        ((n = s),
                        fe(e.clipboardData || n.getDoc().dataTransfer)),
                    o = 'text' === l.get() || c,
                    i = de(a, I);
                (c = !1),
                    !(
            ...
            return {
                ...
                getHtml: function () {
                    return (function (n) {
                        ...
                        for (
                            var a = n.dom.select('div[id=mcepastebin]', r),
                                o = a.length - 1;
                            0 <= o;
                            o--
                        ) {
        ...
        Oe = function (e, t, n) {
            if (
                ((r = e),
                !1 !== w.iOS ||
                    'function' != typeof (null == r ? void 0 : r.setData))
            )
                return !1;
            try {
                return (
    ...
    function $e(e, t, n, r) {
        ...
        return !1 === e.getParam('paste_remove_styles_if_webkit', !0) ||
            'all' === a
            ? t
            : (a && (l = a.split(/[, ]/)),
              (t = (t = l
