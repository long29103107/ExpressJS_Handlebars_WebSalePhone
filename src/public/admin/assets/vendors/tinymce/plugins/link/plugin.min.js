    ...
    var n,
        ...
        _ = function (t, n) {
            return S(
                (function (t, n) {
                    for (
                        var e = t.length, r = new Array(e), o = 0;
                        o < e;
                        o++
                    ) {
                        var i = t[o];
        ...
        Q = function (t, n) {
            return (
                ...
                nt(n)
                    ? t.dom.select('a[href]', n)[0]
                    : t.dom.getParent(n, 'a[href]')
            );
        },
        Y = function (t, n) {
            var e = n
        ...
        nt = function (t) {
            return (
                t && 'FIGURE' === t.nodeName && /\bimage\b/i.test(t.className)
            );
        },
        et = function (t) {
            return (
        ...
        ft = function (t) {
            return (
                V((n = t), (e = 'items')) && n[e] !== undefined && null !== n[e]
            );
            var n, e;
        },
        st = function (n, t) {
                ...
                r = function (t) {
                    var n,
                        ...
                        r =
                            ...
                            D(
                                u.text.length <= 0,
                                N.from(n.meta.text).getOr(n.value),
                            )),
                        o =
                            ((e = t.url),
                            D(
                                u.title.length <= 0,
                                N.from(e.meta.title).getOr(''),
                            ));
                    ...
                    return (
                        ...
                        (d = gt(m, g)),
                        {
                            ...
                            body: {
                                ...
                                items: S([
                                    ...
                                    (function (t) {
                                        ...
                                        g.link.map(
                                            B.createUi('link', 'Link list'),
                                        ),
                                        g.classes.map(
                                            B.createUi('linkClass', 'Class'),
                                        ),
                                    ]),
                                ]),
                            },
                            ...
                            onChange: function (n, t) {
                                var e = t.name;
                                d.onChange(n.getData, { name: e }).each(
                                    function (t) {
                                        n.setData(t);
                                    },
                                );
        ...
        Rt = function (t, n) {
            ...
            n &&
                ...
                /^#/.test(e)
                    ? (r = t.$(e)).length &&
                      t.selection.scrollIntoView(r[0], !0)
                    : Tt(n.href));
        },
        Dt = function (t) {
            return function () {
        ...
        qt = function (r) {
            return function (n) {
                var e = function (t) {
                        return (
                            Z(t) ||
                            ((n = r.selection.getRng()), 0 < G(n, H).length)
                        );
                        var n;
                    },
        ...
        (n = t).ui.registry.addToggleButton('link', {
            ...
            (i = t).ui.registry.addContextForm('quicklink', {
                ...
                predicate: function (t) {
                    return (
                        !!Q(i, t) &&
                        i.getParam('link_context_toolbar', !1, 'boolean')
                    );
                },
                initValue: function () {
                    var t = Q(i);
