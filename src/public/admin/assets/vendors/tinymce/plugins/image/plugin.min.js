...
!(function () {
    ...
    var t,
        ...
        T = function (e) {
            return (
                (t = e), (n = 0) <= n && n < t.length ? S.some(t[n]) : S.none()
            );
            var t, n;
        },
        C =
        ...
        pe = function (t, e) {
            ...
            ce(
                ...
                ne(s.parentNode)
                    ? ((r = s.parentNode),
                      ge(t, r),
                      t.selection.select(s.parentNode))
                    : (t.selection.select(s),
                      ...
                      (l = function () {
                          (o.onload = o.onerror = null),
                              a.selection &&
                                  (a.selection.select(o), a.nodeChanged());
                      }),
                      ((o = s).onload = function () {
                          i.width ||
                              i.height ||
    ...
    var Ue = function (e) {
        ...
        Oe = function (r) {
            var t,
                ...
                w = S.some(
                    r.getParam('image_prepend_url', '', 'string'),
                ).filter(function (e) {
            ...
            (n = e),
                ...
                (/^(?:[a-zA-Z]+:)?\/\//.test(r)
                    ...
                    : n.prependURL.bind(function (e) {
                          return r.substring(0, e.length) !== e
                              ? S.some(e + r)
                              : S.none();
                      })
                ).each(function (e) {
    ...
    a.add('image', function (e) {
        ...
        (t = e).on('PreInit', function () {
            ...
            n.ui.registry.addContextMenu('image', {
                update: function (e) {
                    return ne(e) || ('IMG' === e.nodeName && !k(e))
                        ? ['image']
                        : [];
                },
            }),
