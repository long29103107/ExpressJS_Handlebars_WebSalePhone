    ...
    var r = function (i, r) {
            ...
            function s(e) {
                var t = o(c(e)),
                    n = r.dom.createRng();
                return (
                    n.setStartBefore(t[0]), n.setEndAfter(t[t.length - 1]), n
                );
            }
            var l = (function u(e) {
                var t;
            ...
            return {
                        ...
                        a.length &&
                            (function (e, t, n) {
                                ...
                                function (e) {
                                    ...
                                    (t = i.createTextNode(
                                        r.data.substring(0, e.startNodeIndex),
                                    )),
                                        (n = i.createTextNode(
                                            o.data.substring(e.endNodeIndex),
                                        ));
                                    for (
                                        var u = m(
                                                r.data.substring(
                                    ...
                                    var p = m(
                                        o.data.substring(0, e.endNodeIndex),
                                        a,
                                    );
                                    return (
                ...
                replace: function (e, t) {
                    ...
                    return (
                        n.deleteContents(),
                        0 < t.length &&
                            n.insertNode(r.dom.doc.createTextNode(t)),
                        n
                    );
                },
                rangeFromMatch: s,
                    ...
                    (n['addToDictionary' === e ? 'word' : 'text'] = t),
                        ...
                        f.send({
                            ...
                            error: function () {
                                var e =
                                    c.translate(
                                        'The spelling service was not found: (',
                                    ) +
                                    h(c) +
                                    c.translate(')');
                                o(e);
        ...
        o = function (t, e, n, r, o, a) {
            t.selection.collapse(),
                a
                    ? g.each(
                          t.dom.select('span.mce-spellchecker-word'),
                          function (e) {
                              e.getAttribute('data-mce-word') === r &&
                                  t.dom.remove(e, !0);
                          },
                      )
                    : t.dom.remove(o, !0),
        ...
        S = function (t, e, n, r, o) {
            ...
            if (
                ...
                return (
                    t.notificationManager.open({ text: c, type: 'info' }),
                    void e.set(!1)
                );
            }
            ...
            return (
                g.each(n, function (e) {
                    t.push({
                        text: e,
                        onAction: function () {
                            c.insertContent(c.dom.encode(e)),
                                c.dom.remove(h),
                                v(c, l, u);
                        },
                    });
            ...
            o.ui.registry.addContextMenu('spellchecker', {
                update: function (e) {
                    ...
                    var n = (function (e, t) {
                        var n = [],
                            r = g.toArray(
                                e.getBody().getElementsByTagName('span'),
                            );
                        if (r.length)
