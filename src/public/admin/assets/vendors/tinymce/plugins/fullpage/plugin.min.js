                    ...
                    var t = e.getData(),
                        n = (function (e, o, t) {
                            ...
                            (c = s.getAll('head')[0]) ||
                                ...
                                o.doctype
                                    ? (r ||
                                          ((r = new m('#doctype', 10)),
                                          o.xml_pi
                                              ? s.insert(r, s.firstChild)
                                              : a(r)),
                                      (r.value = o.doctype.substring(
                                          9,
                                          o.doctype.length - 1,
                                      )))
                                    : r && r.remove(),
                                ...
                                p.each(s.getAll('meta'), function (e) {
                                    'Content-Type' === e.attr('http-equiv') &&
                                        (r = e);
                                }),
                                o.docencoding
                                    ? (r ||
                                      ...
                                      r.attr(
                                          'content',
                                          'text/html; charset=' + o.docencoding,
                                      ))
                                    : r && r.remove(),
                                (r = s.getAll('title')[0]),
                                o.title
                            ...
                            var u = f({
                                ...
                                indent: !0,
                                indent_before:
                                    'head,html,body,meta,title,script,link,style',
                                indent_after:
                                    'head,html,body,meta,title,script,link,style',
                            }).serialize(s);
                ...
                ('raw' === l.format && t.get()) ||
                    ...
                    (0 !== r.length ||
                        ...
                        (r =
                            ...
                            p.trim(n.get())),
                    -1 !==
                    (i = (r = r.replace(/<(\/?)BODY/gi, '<$1body')).indexOf(
                        '<body',
                    ))
                        ? ((i = r.indexOf('>', i)),
