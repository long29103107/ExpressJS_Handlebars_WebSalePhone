        ...
        pe = Object.freeze({
            ...
            bindClickHandler: function () {
                (oe[
                    ...
                    ne ||
                        (document.body.addEventListener('click', ie),
                        (ne = !0));
            },
        });
    function fe() {
    ...
    function Ae(t, e, n, o) {
        n
            ...
            : (Xt().then(function () {
              ...
              ee.keydownTarget.removeEventListener(
                  'keydown',
                  ee.keydownHandler,
    ...
    function Bn(a, c, s) {
        return new Promise(function (t) {
            ...
            ke.swalPromiseResolve.set(a, t),
                ...
                (s.toast && (s.input || s.footer || s.showCloseButton)
                    ? vt
                    : bt)(document.body, $['toast-column']),
                (r = a),
            ...
            _destroy: function () {
                ...
                e &&
                    ...
                    ee.deferDisposalTimer &&
                        (clearTimeout(ee.deferDisposalTimer),
