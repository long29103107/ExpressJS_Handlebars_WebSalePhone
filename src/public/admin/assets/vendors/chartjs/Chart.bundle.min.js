    ...
    var je = $.extend({
            ...
            getTitle: function () {
                var t = this,
                    ...
                    o = [];
                return (
                    (o = ze(o, Ee(i))), (o = ze(o, Ee(a))), (o = ze(o, Ee(r)))
                );
            },
            ...
            getFooter: function () {
                var t = this,
                    ...
                    r = [];
                return (
                    (r = ze(r, Ee(n))), (r = ze(r, Ee(i))), (r = ze(r, Ee(a)))
                );
            },
            update: function (t) {
                var e,
                ...
                var t = this,
                    ...
                    a = (t.ticks = (function (t, e) {
                        ...
                        (r = Math.ceil(g / m) - Math.floor(f / m)) > u &&
                            ...
                            s &&
                                (!Sn(d) &&
                                    H.almostWhole(d / m, m / 1e3) &&
                                    (i = d),
                                !Sn(h) &&
                                    H.almostWhole(h / m, m / 1e3) &&
                                    (a = h)),
                            (r = (a - i) / m),
                ...
                (t.min = Rn(e.min, t.min)),
                    ...
                    t.min === t.max &&
                        (0 !== t.min && null !== t.min
                            ? ((t.min = Math.pow(
                                  10,
                                  Math.floor(In(t.min)) - 1,
                              )),
                              (t.max = Math.pow(10, Math.floor(In(t.max)) + 1)))
                            : ((t.min = 1), (t.max = 10))),
                    null === t.min &&
                        (t.min = Math.pow(10, Math.floor(In(t.max)) - 1)),
                    null === t.max &&
                        (t.max =
                            0 !== t.min
                                ? Math.pow(10, Math.floor(In(t.min)) + 1)
                                : 10),
                    null === t.minNotZero &&
                        (t.min > 0
                            ? (t.minNotZero = t.min)
            ...
            getPixelForValue: function (t) {
                ...
                return (
                    (t = +e.getRightValue(t)) > e.min &&
                        t > 0 &&
                        (n =
                            (In(t) - e._startValue) / e._valueRange +
                            e._valueOffset),
