...
!(function (t, e) {
    ...
    V.extend(G.prototype, {
        ...
        pivot: function () {
            var t = this;
            return (
                t._view || (t._view = V.extend({}, t._model)),
                (t._start = {}),
                t
            );
        },
    ...
    var Dt = nt.extend({
            ...
            _resolveDataElementOptions: function () {
                var t = this,
                    e = V.extend(
                        {},
                        nt.prototype._resolveDataElementOptions.apply(
                            t,
                            arguments,
                        ),
                    ),
    ...
    var Ft = nt.extend({
            ...
            _resolveDataElementOptions: function (t, e) {
                var n = this,
                    ...
                    r = t.custom || {},
                    o = a.data[e] || {},
                    s = nt.prototype._resolveDataElementOptions.apply(
                        n,
                        arguments,
                    ),
                    l = {
            ...
            callbacks: {
                ...
                label: function (t, e) {
                    var n = e.labels[t.index],
                        i = ': ' + e.datasets[t.datasetIndex].data[t.index];
                    return (
                        V.isArray(n) ? ((n = n.slice())[0] += i) : (n += i), n
                    );
                },
            },
        },
    ...
    var Zt = nt.extend({
        ...
        _resolveDatasetElementOptions: function () {
            var t = this,
                e = t._config,
                n = t.chart.options,
                i = nt.prototype._resolveDatasetElementOptions.apply(
                    t,
                    arguments,
                );
            return (
    ...
    var je = X.extend({
            ...
            getTitle: function () {
                var t = this,
                    ...
                    o = [];
                return (
                    (o = Be(o, Ee(i))), (o = Be(o, Ee(a))), (o = Be(o, Ee(r)))
                );
            },
            ...
            getFooter: function () {
                var t = this,
                    ...
                    r = [];
                return (
                    (r = Be(r, Ee(n))), (r = Be(r, Ee(i))), (r = Be(r, Ee(a)))
                );
            },
            update: function (t) {
                var e,
                ...
                if (on(s))
                    for (r = 0, o = s.length; r < o; ++r)
                        (g = s[r]),
                            sn(g) ||
                                on(g) ||
                                ((c = V.measureText(t, d.data, d.gc, c, g)),
                                (f += h));
                ...
                var t = this,
                    ...
                    a = (t.ticks = (function (t, e) {
                        ...
                        (r = Math.ceil(g / p) - Math.floor(f / p)) > u &&
                            ...
                            s &&
                                (!Mn(d) &&
                                    V.almostWhole(d / p, p / 1e3) &&
                                    (i = d),
                                !Mn(h) &&
                                    V.almostWhole(h / p, p / 1e3) &&
                                    (a = h)),
                            (r = (a - i) / p),
    ...
    var Rn = xn.extend({
            determineDataLimits: function () {
                ...
                (o.min = V.isFinite(o.min) ? o.min : null),
                    ...
                    (o.minNotZero = V.isFinite(o.minNotZero)
                        ? o.minNotZero
                        : null),
            ...
            handleTickRangeOptions: function () {
                ...
                (t.min = On(e.min, t.min)),
                    ...
                    null === t.max &&
                        (t.max =
                            0 !== t.min
                                ? Math.pow(10, Math.floor(Fn(t.min)) + 1)
                                : 10),
                    null === t.minNotZero &&
                        (t.min > 0
                            ? (t.minNotZero = t.min)
            ...
            getPixelForValue: function (t) {
                ...
                return (
                    (t = +e.getRightValue(t)) > e.min &&
                        t > 0 &&
                        (n =
                            (Fn(t) - e._startValue) / e._valueRange +
                            e._valueOffset),
                ...
                return (
                    ...
                    (i._majorUnit =
                        s.major.enabled && 'year' !== i._unit
                            ? (function (t) {
                                  for (
                                      var e = ei.indexOf(t) + 1, n = ei.length;
                                      e < n;
                                      ++e
                                  )
                ...
                if (((a.font = r.string), u)) {
                    ...
                    (a.textAlign = 'left'),
                        ...
                        V.each(t.legendItems, function (t, e) {
                            var i =
                                Ci(n, o) + o / 2 + a.measureText(t.text).width;
                            (0 === e ||
