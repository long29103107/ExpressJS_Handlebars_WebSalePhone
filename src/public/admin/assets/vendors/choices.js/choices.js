    ...
    return /******/ (function (modules) {
        ...
        /******/ [
            ...
            /***/ function (module, __webpack_exports__, __webpack_require__) {
                ...
                var fuse_default =
                    /*#__PURE__*/ __webpack_require__.n(dist_fuse);
                    ...
                    return function combination(state, action) {
                        ...
                        for (var _i = 0; _i < finalReducerKeys.length; _i++) {
                            ...
                            if (typeof nextStateForKey === 'undefined') {
                                var errorMessage =
                                    getUndefinedStateErrorMessage(_key, action);
         ...
         */
                        ...
                        case 'FILTER_CHOICES': {
                            return state.map(function (obj) {
                                ...
                                choice.active = action.results.some(function (
                                    _ref,
                                ) {
                                    var item = _ref.item,
                                        score = _ref.score;
                ...
                var container_Container =
                    ...
                    (function () {
                        ...
                        _proto.setActiveDescendant =
                            function setActiveDescendant(activeDescendantID) {
                ...
                var list_List =
                    ...
                    (function () {
                        ...
                        _proto.scrollToChildElement =
                            function scrollToChildElement(element, direction) {
                                var _this = this;
                                ...
                                var elementPos =
                                    element.offsetTop + elementHeight; // Difference between the element and scroll position
                        ...
                        wrapped_input_createClass(WrappedInput, [
                            {
                                ...
                                set: function set(items) {
                                    var itemValues = items.map(function (
                                        _ref2,
                                    ) {
                                        var value = _ref2.value;
                                        return value;
                                    });
                                    var joinedValues = itemValues.join(
                                        this.delimiter,
                                    );
                                    this.element.setAttribute(
                                        'value',
                        ...
                        wrapped_select_createClass(WrappedSelect, [
                            ...
                            },
                            {
                                ...
                                set: function set(options) {
                                    ...
                                    var addOptionToFragment =
                                        function addOptionToFragment(data) {
                    ...
                    (function () {
                        ...
                        function Choices(element, userConfig) {
                            ...
                            this.config = cjs_default.a.all(
                                ...
                                {
                                    arrayMerge: function arrayMerge(
                                        _,
                                        sourceArray,
                                    ) {
                            ...
                            if (!this._direction) {
                                var _window$getComputedSt =
                                    ...
                                    elementDirection =
                                        _window$getComputedSt.direction;
                                ...
                                var _window$getComputedSt2 =
                                    ...
                                    documentDirection =
                                        _window$getComputedSt2.direction;
                            ...
                            this._presetGroups =
                                this.passedElement.optionGroups; // Assign preset options from passed element
                            ...
                            if (this.passedElement.options) {
                                this.passedElement.options.forEach(function (
                                    o,
                                ) {
                                    _this._presetChoices.push({
                                        ...
                                        selected: o.selected,
                                        disabled:
                                            o.disabled || o.parentNode.disabled,
                                        placeholder:
                                            o.value === '' ||
                        ...
                        _proto.highlightItem = function highlightItem(
                            ...
                            var id = item.id,
                                ...
                                groupId =
                                    _item$groupId === void 0
                                        ? -1
                                        : _item$groupId,
                                _item$value = item.value,
                                value =
                                    _item$value === void 0 ? '' : _item$value,
                                _item$label = item.label,
                                label =
                                    _item$label === void 0 ? '' : _item$label;
                            var group =
                                groupId >= 0
                        ...
                        _proto.unhighlightItem = function unhighlightItem(
                            item,
                        ) {
                            if (!item) {
                                return this;
                            ...
                            var id = item.id,
                                ...
                                groupId =
                                    _item$groupId2 === void 0
                                        ? -1
                                        : _item$groupId2,
                                _item$value2 = item.value,
                                value =
                                    _item$value2 === void 0 ? '' : _item$value2,
                                _item$label2 = item.label,
                                label =
                                    _item$label2 === void 0 ? '' : _item$label2;
                            var group =
                                groupId >= 0
                                    ? this._store.getGroupById(groupId)
                                    : null;
                        ...
                        _proto.removeActiveItemsByValue =
                            function removeActiveItemsByValue(value) {
                                var _this4 = this;
                        ...
                        _proto.removeHighlightedItems =
                            function removeHighlightedItems(runEvent) {
                                var _this6 = this;
                        ...
                        _proto.getValue = function getValue(valueOnly) {
                            ...
                            var values = this._store.activeItems.reduce(
                        ...
                        _proto.setChoiceByValue = function setChoiceByValue(
                            value,
                        ) {
                            var _this10 = this;
                            ...
                            var choiceValue = Array.isArray(value)
                                ? value
                                : [value]; // Loop through each value and
                        ...
                        _proto.setChoices = function setChoices(
                            ...
                            if (typeof choicesArrayOrFetcher === 'function') {
                                ...
                                if (
                                    ...
                                    return new Promise(function (resolve) {
                                        ...
                                        .then(function () {
                                            return _this11._handleLoadingState(
                                                true,
                                            );
                                        })
                                        .then(function () {
                            ...
                            choicesArrayOrFetcher.forEach(function (
                                groupOrChoice,
                            ) {
                                if (groupOrChoice.choices) {
                                    _this11._addGroup({
                                        id:
                                            parseInt(groupOrChoice.id, 10) ||
                                            null,
                                        group: groupOrChoice,
                                        valueKey: value,
                                        labelKey: label,
                        ...
                        _proto._renderChoices = function _renderChoices() {
                            ...
                            if (
                                ...
                                var activePlaceholders = activeChoices.filter(
                        ...
                        _proto._renderItems = function _renderItems() {
                            ...
                            var itemListFragment =
                                this._createItemsFragment(activeItems); // If we have items to add, append them
                        ...
                        _proto._createGroupsFragment =
                            function _createGroupsFragment(
                                groups,
                                choices,
                                fragment,
                            ) {
                                ...
                                var getGroupChoices = function getGroupChoices(
                                    group,
                                ) {
                        ...
                        _proto._createChoicesFragment =
                            function _createChoicesFragment(
                                choices,
                                fragment,
                                withinGroup,
                            ) {
                                ...
                                var _this$config = this.config,
                                    ...
                                    searchResultLimit =
                                        _this$config.searchResultLimit,
                                    renderChoiceLimit =
                                        _this$config.renderChoiceLimit;
                                ...
                                var _rendererableChoices$ =
                                        rendererableChoices.reduce(
                                            function (acc, choice) {
                                    ...
                                    normalChoices =
                                        _rendererableChoices$.normalChoices; // If sorting is enabled or the user is searching, filter choices
                        ...
                        _proto._createItemsFragment =
                            function _createItemsFragment(items, fragment) {
                                var _this15 = this;
                                ...
                                var _this$config2 = this.config,
                                    shouldSortItems =
                                        _this$config2.shouldSortItems,
                                    sorter = _this$config2.sorter,
                                    removeItemButton =
                                        _this$config2.removeItemButton; // If sorting is enabled, filter items
                                ...
                                var addItemToFragment =
                                    function addItemToFragment(item) {
                        ...
                        _proto._selectPlaceholderChoice =
                            function _selectPlaceholderChoice() {
                        ...
                        _proto._handleButtonAction =
                            function _handleButtonAction(activeItems, element) {
                                if (
                                    !activeItems ||
                                    !element ||
                                ...
                                var itemToRemove = activeItems.find(function (
                                    item,
                                ) {
                        ...
                        _proto._handleChoiceAction =
                            function _handleChoiceAction(activeItems, element) {
                        ...
                        _proto._handleLoadingState =
                            function _handleLoadingState(setLoading) {
                        ...
                        _proto._searchChoices = function _searchChoices(value) {
                            ...
                            this._store.dispatch(
                                choices_filterChoices(results),
                            );

                            return results.length;
                        };

                        _proto._addEventListeners =
                        ...
                        _proto._onKeyDown = function _onKeyDown(event) {
                            ...
                            var keyDownActions =
                                ...
                                (_keyDownActions[UP_KEY] =
                                    this._onDirectionKey),
                                (_keyDownActions[PAGE_UP_KEY] =
                                    this._onDirectionKey),
                                (_keyDownActions[DOWN_KEY] =
                                    this._onDirectionKey),
                                (_keyDownActions[PAGE_DOWN_KEY] =
                                    this._onDirectionKey),
                                (_keyDownActions[DELETE_KEY] =
                                    this._onDeleteKey),
                        ...
                        _proto._onKeyUp = function _onKeyUp(_ref2) {
                            ...
                            if (this._isTextElement) {
                                ...
                                var canSearch =
                                    this._canSearch && canAddItem.response;
                        ...
                        _proto._onDirectionKey = function _onDirectionKey(
                            _ref6,
                        ) {
                        ...
                        _proto._onFocus = function _onFocus(_ref11) {
                            ...
                            var focusActions =
                                ...
                                (_focusActions[SELECT_MULTIPLE_TYPE] =
                                    function () {
                                        if (target === _this17.input.element) {
                        ...
                        _proto._onBlur = function _onBlur(_ref12) {
                            ...
                            if (
                                ...
                                var blurActions =
                                    ...
                                    (_blurActions[SELECT_ONE_TYPE] =
                                        function () {
                                            _this18.containerOuter.removeFocusState();

                                            if (
                                                target ===
                                                    _this18.input.element ||
                                                (target ===
                                    ...
                                    (_blurActions[SELECT_MULTIPLE_TYPE] =
                                        function () {
                                            if (
                        ...
                        _proto._highlightChoice = function _highlightChoice(
                            el,
                        ) {
                            var _this19 = this;
                        ...
                        _proto._addItem = function _addItem(_ref13) {
                            var value = _ref13.value,
                                ...
                                choiceId =
                                    _ref13$choiceId === void 0
                                        ? -1
                                        : _ref13$choiceId,
                                _ref13$groupId = _ref13.groupId,
                                groupId =
                                    _ref13$groupId === void 0
                                        ? -1
                                        : _ref13$groupId,
                        ...
                        _proto._addGroup = function _addGroup(_ref15) {
                            ...
                            if (groupChoices) {
                                ...
                                var addGroupChoices = function addGroupChoices(
                                    choice,
                                ) {
                                    var isOptDisabled =
                                        choice.disabled ||
                                        (choice.parentNode &&
                                            choice.parentNode.disabled);
                        ...
                        _proto._getTemplate = function _getTemplate(template) {
                            ...
                            return (_this$_templates$temp =
                                this._templates[template]).call.apply(
                        ...
                        _proto._addPredefinedGroups =
                            function _addPredefinedGroups(groups) {
                                var _this21 = this;
                                ...
                                if (
                                    placeholderChoice &&
                                    placeholderChoice.parentNode.tagName ===
                                        'SELECT'
                                ) {
                                    this._addChoice({
                                        value: placeholderChoice.value,
                        ...
                        _proto._addPredefinedChoices =
                            function _addPredefinedChoices(choices) {
                                var _this22 = this;
                                ...
                                var hasSelectedChoice = choices.some(function (
                                    choice,
                                ) {
                                    return choice.selected;
                                });
                                var firstEnabledChoiceIndex = choices.findIndex(
                                    function (choice) {
                                        return (
                        ...
                        _proto._addPredefinedItems =
                            function _addPredefinedItems(items) {
                                var _this23 = this;
                        ...
                        _proto._setChoiceOrItem = function _setChoiceOrItem(
                            item,
                        ) {
                            var _this24 = this;
                        ...
                        _proto._findAndSelectChoiceByValue =
                            function _findAndSelectChoiceByValue(val) {
                                var _this25 = this;
                                ...
                                var foundChoice = choices.find(function (
                                    ...
                                    return _this25.config.valueComparer(
                                        choice.value,
                                        val,
                                    );
                                });
                        ...
                        _proto._generatePlaceholderValue =
                            function _generatePlaceholderValue() {
                                if (this._isSelectElement) {
                                ...
                                var _this$config4 = this.config,
                                    ...
                                    placeholderValue =
                                        _this$config4.placeholderValue;
                                var dataset =
                ...
                /* harmony default export */ var scripts_choices =
