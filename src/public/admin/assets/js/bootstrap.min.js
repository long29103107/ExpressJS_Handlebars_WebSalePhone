            ...
            return (
                ...
                (n._setActiveIndicatorElement = function (t) {
                    if (this._indicatorsElement) {
                        for (
                            var e = V.find('.active', this._indicatorsElement),
                                n = 0;
                            n < e.length;
                            n++
                        )
                ...
                (n._slide = function (t, e) {
                    ...
                    if (
                        ...
                        !this._triggerSlideEvent(l, o).defaultPrevented &&
                        r &&
                        l
                    ) {
                        if (
    ...
    var nt = 'collapse',
        ...
        st = (function (t) {
            function e(e, n) {
                ...
                for (
                    var o = V.find('[data-bs-toggle="collapse"]'),
                        s = 0,
                        r = o.length;
                    s < r;
                    s++
            ...
            return (
                ...
                (a.show = function () {
                    if (
                        ...
                        if (
                            !Q.trigger(this._element, 'show.bs.dropdown', o)
                                .defaultPrevented
                        ) {
                            if (!this._inNavbar) {
                                if (void 0 === n)
                            ...
                            if (
                                ...
                                if (e[n].classList.contains('show'))
                                    if (
                                        ...
                                        if (
                                            !Q.trigger(s, 'hide.bs.dropdown', a)
                                                .defaultPrevented
                                        ) {
                                            var c;
                                            if (
            ...
            return (
                ...
                (n._showElement = function (t) {
                    ...
                    var o = function () {
                        e._config.focus && e._element.focus(),
                            ...
                            Q.trigger(e._element, 'shown.bs.modal', {
                                relatedTarget: t,
                            });
                    };
                    if (n) {
                        var s = h(this._dialog);
                        Q.one(this._dialog, 'transitionend', o),
                            m(this._dialog, s);
                    } else o();
                }),
                ...
                (n._showBackdrop = function (t) {
                    ...
                    if (this._isShown && this._config.backdrop) {
                        ...
                        Q.one(this._backdrop, 'transitionend', t),
                            m(this._backdrop, i);
                        ...
                        if (this._element.classList.contains('fade')) {
                            ...
                            Q.one(this._backdrop, 'transitionend', o),
                                m(this._backdrop, s);
                        } else o();
                    } else t();
                }),
            ...
            return (
                ...
                (n._activate = function (t) {
                    ...
                    n.classList.contains('dropdown-item')
                        ...
                        : (n.classList.add('active'),
                          V.parents(n, '.nav, .list-group').forEach(function (
                              t,
                          ) {
                ...
                (n.show = function () {
                    ...
                    if (
                        ...
                        if (
                            ...
                            Q.one(this._element, 'transitionend', e),
                                m(this._element, n);
                        } else e();
                    }
                }),
